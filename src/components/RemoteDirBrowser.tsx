    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-content w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-2 mb-4 p-2 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-visible)]">
          <button
            onClick={handleGoUp}
            className="px-2 py-1 text-sm font-mono rounded bg-[var(--bg-surface)] border border-[var(--border-visible)] text-[var(--text-muted)] hover:text-[var(--accent-primary)] hover:border-[var(--accent-primary)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="h-64 overflow-y-auto mb-4 rounded-lg border border-[var(--border-visible)]">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full p-4 gap-3">
              <span className="text-sm font-mono text-[var(--accent-danger)] text-center">{error}</span>
